...
abstract final class AppTextStyles {
  ...
  static const whiteBold36 = TextStyle(
      fontSize: 36, color: AppColors.white, fontWeight: FontWeight.bold);
  ...
  static const goldBold20 = TextStyle(
      fontSize: 20, color: AppColors.gold, fontWeight: FontWeight.bold);
  static const goldBold24 = TextStyle(
      fontSize: 24, color: AppColors.gold, fontWeight: FontWeight.bold);
}
